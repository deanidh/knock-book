...
const ReadingPage: React.FC<Props> = ({ book, onClose }) => {
  ...
  return (
    <div
      className="relative bg-white rounded-lg shadow-lg w-full max-w-2xl h-[90vh] overflow-hidden"
      onClick={(e) => e.stopPropagation()}
    >
      <div className="sticky top-0 z-20 bg-white rounded-lg flex justify-end px-4 py-2 h-12">
        <button className=" text-gray-600 text-xl" onClick={onClose}>
          ✖
        </button>
      </div>
      <div className="px-8 pb-4 overflow-y-auto h-[calc(90vh-48px)]">
